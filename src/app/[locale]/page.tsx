...
import { AuthenticatedHomeShell } from "@/components/social-home/authenticated-home-shell";
...
export default function HomePage() {
    ...
    const { auth, isAuthenticated } = useStoredAuth();
    ...
    if (isAuthenticated && auth) {
        return <AuthenticatedHomeShell locale={locale} auth={auth} />;
    }
    ...
    return (
        <main className="min-h-screen bg-surface-base text-ink-strong">
            <header className="sticky top-0 z-50 border-b border-line-subtle bg-surface-base/90 backdrop-blur">
                <div className="mx-auto flex max-w-7xl flex-col gap-4 px-2 py-4 md:flex-row md:items-center md:gap-6">
                                ...
                                >
                                    ...
                                    <SheetContent className="w-[88vw] max-w-sm bg-surface-panel px-6 py-16 md:hidden">
                                        <nav className="flex flex-col gap-4 text-base font-medium text-ink-body">
                                            ...
                                            <a
                                                href="#login"
                                                className="rounded-2xl bg-accent-500 px-4 py-3 text-center font-semibold text-ink-inverse transition hover:bg-accent-700"
                                                onClick={() =>
                                                    setIsMobileMenuOpen(false)
                                                }
                                            >
                    ...
                    <div className="flex w-full flex-col gap-3 md:ml-auto md:w-auto md:flex-row md:items-center">
                        ...
                        <div className="flex items-center gap-2 md:gap-3 w-full">
                            <a
                                href="#login"
                                className="hidden h-10 w-full items-center justify-center rounded-full border border-line-subtle bg-surface-raised px-4 text-sm font-semibold text-ink-strong transition hover:border-accent-500 md:inline-flex md:w-auto"
                            >
                                {t("signIn")}
                            </a>
            ...
            >
                ...
                <div className="relative mx-auto grid max-w-7xl gap-10 px-6 py-20 lg:grid-cols-[0.95fr_1.05fr] lg:px-10">
                    ...
                    <div
                        id="login"
                        className="mx-auto w-full max-w-md scroll-mt-32"
                    >
